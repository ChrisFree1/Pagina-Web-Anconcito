    ...
    <div class="container">
      <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            ...
            <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-7-3">
                  <p style="font-size: 19px;text-align: justify;"><b>Dirección:</b> Barrio Gonzalo Chávez. Calle 18 de Diciembre y av. Wilson Ortiz<br>
                    <b>Número de teléfono: </b>0993598208<br>
                    <b>Otros contactos:</b> Facebook Cevichería D´ Fruko<br>
        ...
        <div class="col-lg-6 text-center wow fadeInUp">
          <a href="../PaginaValoraciones.php?img=anconcito/imagenes/anconcito/0121_gastronomia.jpg">
            <img src="imagenes/anconcito/0121_gastronomia.jpg" id="Cevichería De Fruko" alt="" width="556" height="382" />
          </a>
        </div>
      </div>
    </div>
  ...
  <section class="section section-sm section-first bg-default text-md-left">
    <div class="container">
      <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
          ...
          <div class="box-width-lg-470">
            ...
            <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-7-3-1">
                  <p style="font-size: 19px;text-align: justify;"><b>Dirección:</b> Puerto Pesquero Artesanal de Anconcito<br>
                    <b>Número de teléfono: </b>09958758613<br>
                    <b>Otros contactos:</b> Facebook Comedor Mirellita<br>
        ...
        <div class="col-lg-6 text-center wow fadeInUp">
          <a href="../PaginaValoraciones.php?img=anconcito/imagenes/anconcito/0122_comedor_mirellita.jpg">
            <img style="width: 560px; height :390px;" src="imagenes/anconcito/0122_comedor_mirellita.jpg" id="Comedor Mirellita" alt="" width="556" height="382" />
          </a>
        </div>
      </div>
  ...
  <section class="section section-sm section-first bg-default text-md-left">
    <div class="container">
      <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
          ...
          <div class="box-width-lg-470">
            ...
            <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tabs-7-3-2">
                  <p style="font-size: 19px;"><b>Dirección:</b> Puerto Pesquero Artesanal de Anconcito<br>
                    <b>Números de teléfonos: </b>0986996112 – (04) 2946214<br>
                    <b>Otros contactos:</b> Facebook Comedor Don Víctor <br>
        ...
        <div class="col-lg-6 text-center wow fadeInUp">
          <a href="../PaginaValoraciones.php?img=anconcito/imagenes/anconcito/0123_comedor_victor.jpg">
            <img style="width: 560px; height :390px;" src="imagenes/anconcito/0123_comedor_victor.jpg" id="Comedor Don Victor" alt="" width="556" height="382" />
          </a>
        </div>
      </div>
