        ...
        <div class="container-card">
            ...
            <div class="card">
                <div class="contenido-card">
                    ...
                    Whatsapp: +31 206490787     <br><br><br><br>
                    </p>
        ...
        <div class="container-card">
            <div class="card">
                <div class="contenido-card">
                    <h3><b>CLP</b></h3><br>
                    <p>
                    Guayaquil a Santa Elena/ Pasaje - $5.00   <br>
                    </p>
                </div>
            </div>
            <div class="card">
                <div class="contenido-card">
                    <h3><b>Mar Azul</b></h3><br>
                    <p>
                    Costo del pasaje: $0,50                   <br>
                    Duración: 25min.
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        <table>
            ...
            <tr>
                <td>Santa Elena-La libertad<br>Anconcito - Ancón.</td>
                <td>20 min.</td>
                <td>$0.75 ctvs.</td>
            </tr>
            <tr>
                <td>Libertad - Ancón.</td>
                <td>15 min.</td>
                <td>$0.70 ctvs.</td>
            </tr>
            <tr>
                <td>Santa Elena - Ancón.</td>
                <td>10 min.</td>
                <td>$0.50 ctvs.</td>
            </tr>
            <tr>
    ...
    <br>          
            <center><div><iframe src="https://www.google.com/maps/embed?pb=!1m24!1m8!1m3!1d63786.64440190359!2d-80.8919358751444!3d-2.278005536011194!3m2!1i1024!2i768!4f13.1!4m13!3e0!4m5!1s0x902e0905f243c473%3A0x60d1451681204ecf!2sSanta%20Elena!3m2!1d-2.2268901!2d-80.85938449999999!4m5!1s0x902e06fd884e6e13%3A0x4417ef1bb563a1fd!2zQW5jw7Nu!3m2!1d-2.3246629999999997!2d-80.854766!5e0!3m2!1ses!2sec!4v1672625667640!5m2!1ses!2sec" width="50%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div></center>
    <br>

    <div>
        <center><img src="imagenes/ancon/0038_comollegar.png" alt="como llegar"></center>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col" style="border: 1px solid black; margin: 20px;">
            <center><img src="imagenes/ancon/0039_farmacia.png" alt=""></center>
                <p style = "text-align: center; font-size: 17px; font-family: 'Montserrat';"><b>Farmacias</b></p>
                <p style = "text-align: center; font-size: 15px; font-family: 'Montserrat';">
                Santa Marianita.   <br>
                Santa Martha.      <br>
                Comunitaria.       <br>
            ...
            <div class="col" style="border: 1px solid black; margin: 20px;">
            <center><img src="imagenes/ancon/0040_cajero.png" alt=""></center>
                <p style = "text-align: center; font-size: 17px; font-family: 'Montserrat';"><b>Cajero de Banco</b></p>
                <p style = "text-align: center; font-size: 15px; font-family: 'Montserrat';">
                Banco Guayaquil.            <br>
                Banco Pichincha.
                </p>
            ...
            <div class="col" style="border: 1px solid black; margin: 20px;">
            <center><img src="imagenes/ancon/0041_taxi.png" alt=""></center>
                <p style = "text-align: center; font-size: 17px; font-family: 'Montserrat';"><b>Cooperativa de taxis</b></p>
                <p style = "text-align: center; font-size: 15px; font-family: 'Montserrat';">
                ANCOTUR S.A
                </p>
            </div>
