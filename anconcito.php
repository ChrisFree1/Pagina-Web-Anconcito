...
<div class="page">
  ...
  <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="false" data-direction="vertical">
    <div class="swiper-wrapper text-left">
      <div class="swiper-slide context-dark" data-slide-bg="imagenes/anconcito/0056_playa.jpg">
      ...
      <div class="swiper-slide context-dark" data-slide-bg="imagenes/anconcito/0057_playa.jpg">
        <div class="swiper-slide-caption section-md">
          <div class="container">
            <div class="row">
              <div class="col-md-10">
      ...
      <div class="swiper-slide context-dark" data-slide-bg="imagenes/anconcito/0058_playa.jpg">
        <div class="swiper-slide-caption section-md">
          <div class="container">
            <div class="row">
              <div class="col-md-10">
  ...
  <section class="section bg-default text-center offset-top-50">
    <div class="parallax-container" data-parallax-img="imagenes/anconcito/0066_banner.png">
    ...
    <div class="container-fluid">
      ...
      <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-xl-items="5" data-xxl-items="6" data-stage-padding="15" data-xxl-stage-padding="0" data-margin="30" data-autoplay="true" data-nav="true" data-dots="true">
        ...
        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="miradoranconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0067_mirador_encantado.jpg" alt="" /></a>
          </div>

        </article>

        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="puertoanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0068_puerto.jpg" alt="" /></a>
          </div>

        </article>
        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="complejoanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0069_complejo_deportivo.jpg" alt="" /></a>
          </div>
        </article>

        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="estadioanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0070_estadio_dorado1.jpg" alt="" /></a>
          </div>

        </article>
        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="elfaroanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0071_el_faro.jpg" alt="" /></a>
          </div>

        </article>

        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="miradoroctubreanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0072_mirador_octubre.jpg" alt="" /></a>
          </div>

        </article>
        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="albarradaanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0055_tiwintza.jpg" alt="" /></a>
          </div>

        </article>

        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="fragataanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0073_mirador_fragata.jpg" alt="" /></a>
          </div>
        </article>

        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="parquegonzalochavez.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0074_parque_gonzalo.jpg" alt="" /></a>
          </div>
        </article>
        <article class="thumbnail thumbnail-mary">
          <div class="thumbnail-mary-figure"><a href="plazoletaanconcito.php"><img style="width: 270px; height:195px;" src="imagenes/anconcito/0075_plazoleta.jpg" alt="" /></a>
          </div>
        </article>
